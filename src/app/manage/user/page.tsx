...
import { roleSelection } from "@/const/roles";
  ...
  return props.users.map((user, index) => {
    return (
      <div key={index} className="subgrid items-center my-gap-x text-center">
        <div className="subgrid my-my items-center justify-center">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="-col-end-1 col-span-1">
              <Button className="rounded-full  bg-transparent hover:bg-foreground text-foreground hover:text-background">
                &#xFE19;
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
